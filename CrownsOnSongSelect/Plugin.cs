...
using CrownsOnSongSelect.Patches;
using System.IO;
...
#endif
    {
        ...
        public static void LoadPlugin(bool enabled)
        {
            if (enabled)
            {
                ...
                //result &= Instance.PatchFile(typeof(SongSelectCrownIconsPatch)); // Old version, replacing
                result &= Instance.PatchFile(typeof(CrownsOnSongSelectPatch));
                if (result)
                {
